...
ooklaname = 'REDACTED'
ooklapass = 'REDACTED'
# Works  name and password as part of the URL string in this format
ooklaURL = 'https://' + ooklaname + ':' + ooklapass + '@' + ooklaweb.split('https://')[1]
...
# this function downloads the binary files
